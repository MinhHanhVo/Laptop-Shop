...
import { addProductToCart, deleteProductInCart, getDetailProduct, getOrderHistory, getProductInCart, handlePlaceOrder, updateCartDetailBeforeCheckout } from "services/client/item.service";
...
export {
    ...
    getCheckOutPage, postHandleCartToCheckout, postPlaceOrder, getThanksPage, getOrderHistoryPage,
